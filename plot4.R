...
plot(datetime, select_dates$Global_active_power, xlab = "", ylab = "Global Active Power", type = "l")
plot(datetime, select_dates$Voltage, xlab = "datetime", ylab = "Voltage", type = "l")
